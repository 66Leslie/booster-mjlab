...
from mjlab_playground.tasks.velocity.mdp.observations import (
  generated_commands as heading_generated_commands,
)
from mjlab_playground.tasks.velocity.mdp.rewards import track_heading_command
...
def make_velocity_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  actor_terms = {
    ...
    "command": ObservationTermCfg(
      func=heading_generated_commands,
      ...
      params={
        ...
        "velocity_stages": [
          ...
          },
          {
            ...
            "lin_vel_x": (0.0, 3.0),
            "lin_vel_y": (-1.0, 1.0),
            "heading": (-math.pi * 0.5, math.pi * 0.5),
          },
        ],
      },
    ),
